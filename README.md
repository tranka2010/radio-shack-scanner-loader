    ...
    where:   CHANNEL is any number from 1 to 200.
    	 ...
    	 (http://support.radioshack.com/support_tutorials/communications/20-424.htm)
             ...
             FREQUENCY is any number of the form xxx.xxxx which corresponds to a frequency (in MHz)
          	 ...
          	 the transfer and go back to normal operation. The software will zero-pad the frequency 
          	 field accordingly to comply with the xxx.xxxx number format.
    ...
    o The scanner end of the cable is a standard 3.5mm (1/8") Phone Connector. 
    o The computer end of the cable is a standard female DB9 connector. 
    o The sleeve (bottom section) of the phone connector is the ground and is connected to pin 5 (GND) of the 
      DB9 connector. 
    o The ring (middle section) of the phone connector is receive data (RXD) for the scanner and is connected 
      to pin 3 of the DB9 connector which is transfer data (TXD) for the computer. 
    o The tip (top section) of the phone connector is mono audio, for when headphones are connected, and is not connected 
      to the computer end of the cable. 
    
    Note:  These scanners can only listen to data and do not talk back.
    
    
    (ptg 02/21/09 - updated 04/30/2025)
